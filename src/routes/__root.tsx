...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DLF Hamilton Court 2 — Ultra-Luxury 4.5 BHK Residences" },
      { property: "og:description", content: "12.5 acres. 6–7 towers. ~450 residences. 4.5 BHK from ₹27.50 Cr. Gurugram." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "DLF Hamilton Court 2 — Ultra-Luxury Residences" },
      { name: "twitter:description", content: "4.5 BHK residences & penthouses in Gurugram. From ₹27.50 Cr." },
    ],
    links: [
